package com.microape.wifihelper.socket.client.sdk.client;
...
import com.microape.wifihelper.socket.client.impl.client.action.ActionDispatcher;
import com.microape.wifihelper.socket.client.impl.exceptions.DogDeadException;
...
public class OkSocketOptions implements IIOCoreOptions {
    ...
    public static class Builder {
         ...
         * 脉搏丢失次数<br>
         * 大于或等于丢失次数时将断开该通道的连接<br>
         * 抛出{@link com.microape.wifihelper.socket.client.impl.exceptions.DogDeadException}<br>
         * 默认是5次
         *
         ...
         * 如果不需要断线重连请设置该参数为{@link com.microape.wifihelper.socket.client.sdk.client.connection.NoneReconnect}
         *
